...
summary: CMDM 共享 Worker 的跨平台纯 CPU 独立锁定环境。
canonical: plugins/models/cmdm-humanml3d/runtime-cpu/README.md
related:
  - ../runtime/README.md
  - ../../../../registries/runtimes/cmdm-humanml3d-cpu.yaml
supersedes: []
superseded_by: []
---

# CMDM portable CPU runtime

This independent locked project installs the canonical `virea_cmdm` Worker
