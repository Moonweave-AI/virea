...
def test_manifest_registries_and_runtime_freeze_shared_external_assets() -> None:
    ...
    assert cuda.availability == (
        "windows_and_linux_cuda_lock_resolution_verified_runtime_0_1_6_"
        "accelerate_dispatch_removed_requires_reacceptance"
    )
    assert cpu.availability == (
        "cpu_contract_and_lock_baseline_runtime_0_1_6_cpu_staged_materialization_"
